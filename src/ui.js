  ...
  function renderMethod() {
    ...
    <div class="method-cols">
      ...
      <div class="method-block">
        ...
        <p>Four differences do most of the work. <strong>The money is a different kind of money</strong> — it is intermediated by the state rather than by equity markets: special treasury bonds and guidance funds into state telecoms and local governments, rather than public equity into hyperscalers. Nobody in that loop needs a marked-up valuation to keep going, which is why China has no equivalent of the circular vendor financing above — and why losses surface as canceled projects rather than bankruptcies.
        <strong>The revenue is priced differently</strong> — Chinese models serve a majority of the tokens US firms consume, at roughly a tenth to a thirtieth of US prices, so China wins volume share while its revenue share stays in single digits. All of Chinese cloud infrastructure was smaller in 2025 than Google Cloud alone.
        <strong>The constraints are mirrored</strong> — the US is power-limited with silicon available; China is silicon-limited with power abundant. Its binding constraint is memory rather than logic: advanced-node wafer capacity comfortably exceeds what the Ascend line needs, but domestic HBM covers only about half of it, and China's leading DRAM maker has publicly chosen high-margin commodity memory over it.
        <strong>And announced is not deployed</strong> — headline state programs run an order of magnitude above what reaches operating companies. The funding slider here is the deployed flow, not the announcements.</p>
      </div>
      <div class="method-block">
